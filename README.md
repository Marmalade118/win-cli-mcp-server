...
[![NPM Downloads](https://img.shields.io/npm/dt/@marmalade118/server-win-cli.svg?style=flat)](https://www.npmjs.com/package/@marmalade118/server-win-cli)
[![NPM Version](https://img.shields.io/npm/v/@marmalade118/server-win-cli.svg?style=flat)](https://www.npmjs.com/package/@marmalade118/server-win-cli?activeTab=versions)
[![smithery badge](https://smithery.ai/badge/@marmalade118/server-win-cli)](https://smithery.ai/server/@marmalade118/server-win-cli)
...
```json
{
  "mcpServers": {
    "windows-cli": {
      "command": "npx",
      "args": ["-y", "@marmalade118/server-win-cli"]
    }
  }
}
```
...
```bash
npx @marmalade118/server-win-cli --init-config ./config.json
```
